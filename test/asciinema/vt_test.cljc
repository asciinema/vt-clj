(ns asciinema.vt-test
  #?(:cljs (:require-macros [cljs.test :refer [is are deftest testing]]
                            ...
                            [asciinema.vt.test-macros :refer [property-tests-multiplier expect-lines expect-first-line expect-tabs expect-cursor]]))
  (:require #?(:clj [clojure.test :refer [is are deftest testing use-fixtures]]
            ...
            [schema.test]
            #?(:clj [asciinema.vt.test-macros :refer [property-tests-multiplier expect-lines expect-first-line expect-tabs expect-cursor]])
